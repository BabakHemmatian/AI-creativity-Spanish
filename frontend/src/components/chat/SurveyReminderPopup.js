...
/**
 * Reminder shown when a chat round ends (or the full study completes).
 * Prompts the participant to return to the Qualtrics survey before
 * continuing. Purely presentational: it does not read or mutate any
 * session / socket / chat state, so it cannot interfere with the
 * round lifecycle.
 */
export default function SurveyReminderPopup({ open, onClose, isCompleted }) {
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <div className="bg-white dark:bg-gray-700 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-yellow-100 dark:bg-gray-200 sm:mx-0 sm:h-10 sm:w-10">
                    <ExclamationIcon
